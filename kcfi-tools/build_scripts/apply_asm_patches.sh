...
echo "generating kcfi tags and macros"
lua ./build_tools/asm_patchers/kcfi_tags.lua
echo "generating secondary"
lua ./build_tools/asm_patchers/secondary_builder.lua
rm ./build_tools/*.txt
